...
> Livrable 12 · Phase 1 Foundation · Claude Strategist · 06 août 2026 · v1.1
...
> Questions 01 et 02 de la version précédente résolues par ADR-006 (Livrable 10) — retirées du registre.

---

| # | Question | Catégorie | Priorité | Impact | Stratégie de résolution |
|---|---|---|---|---|---|
| 01 | Quel modèle sert de LLM Gateway par défaut au lancement du MVP ? | IA | Basse | Le MVP n'a pas d'usage agent IA structuré — question pertinente seulement à l'entrée en Phase 3 | À trancher à l'ouverture de la Phase 3 |
| 02 | Le MVP a-t-il besoin d'un accès mobile, ou une interface web suffit-elle pour un usage solo ? | UX | Moyenne | Influence l'effort de Phase 2 | À trancher avant la conception détaillée de Project Workspace / Knowledge Hub |
| 03 | À quel volume d'activité le passage à une gestion multi-utilisateurs (ADR-005) devient-il nécessaire ? | Business | Moyenne | Déclenche l'entrée en Phase 3 sur ce volet | Réévalué au moment du recrutement BD ou de l'intégration d'un premier freelance |
